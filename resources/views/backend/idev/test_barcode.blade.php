...
<body>
    <div class="attendance-card">
        ...
        <h3 class="fw-bold text-dark mb-2">Test Karyawan Baru</h3>
        <p class="text-muted mb-4">Silakan pindai kode QR ini untuk melakukan test.</p>
        ...
        <div class="qr-code-section">
            ...
            <p class="mt-3 fw-bold text-primary">Scan untuk Test!</p>
        </div>
