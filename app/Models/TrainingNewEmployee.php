...
class TrainingNewEmployee extends Model
{
    ...
    public function getBtnMultilinkAttribute()
    {
        $arrLink = [
            ...
            // ['label' => 'Test', 'url' => url('employee-test') . "?test_employee_id=" . $this->id, 'icon' => 'ti ti-flask fw-bold'],
            ['label' => 'Question', 'url' => url('question') . "?test_employee_id=" . $this->id, 'icon' => 'ti ti-question-mark fw-bold'],
            ['label' => 'Answer', 'url' => url('user-answer') . "?test_employee_id=" . $this->id, 'icon' => 'ti ti-pencil fw-bold'],
