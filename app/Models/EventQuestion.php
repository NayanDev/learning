...
class EventQuestion extends Model
{
    ...
    protected $fillable = ["workshop_id","user_id","year","letter_number","organizer","speaker","start_date","end_date","divisi","token","token_expired","instructor","location","approve_by","created_date","notes"];
